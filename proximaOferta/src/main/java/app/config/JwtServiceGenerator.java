...
public class JwtServiceGenerator {  
	...
	public static final String SECRET_KEY = "DSAKJASDJKSDAJKSDAJKSKSDADJKSADJSADKLSADSAKDJADJAKDJAKSDJASKDJASKDJASKDJASKDJASKDJASK";
	...
	public Map<String, Object> gerarPayload(Usuario usuario){
		...
		payloadData.put("username", usuario.getUsuario());
